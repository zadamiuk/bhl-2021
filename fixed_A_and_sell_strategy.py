...
A_strategy["Typ podejścia"] = "Podejscie bez akumulatora"
our_strategy["Typ podejścia"] = "Proponowane podejście"
...
fig = px.line(df_to_plot, x="date", y="cost", color="Typ podejścia")
fig.update_layout(
    title_text="Benchmark analizowanych podejść",
    xaxis_title="Data",
    yaxis_title="Kosz potrzebnej energii <br> [zł]",
